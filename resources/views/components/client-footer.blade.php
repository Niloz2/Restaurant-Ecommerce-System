        ...
        <!-- Footer Start -->
        <div class="container-fluid footer py-2 my-6 mb-0 bg-light wow bounceInUp#" {{--data-wow-delay="0.1s"--}}>
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <h1 class="text-primary">Selah<span class="text-dark">Kitchen</span></h1>
                            <p class="lh-lg mb-4">Place your meal order, or book for later to get a meal you ever dreamed about.</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <h4 class="mb-4">Special Menus</h4>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                <p><i class="fa fa-map-marker-alt text-primary me-2"></i> Tanzania, Dodoma, Medeli near Mabeyo hall</p>
                                <p><i class="fa fa-phone-alt text-primary me-2"></i> (+255) 755 853 035</p>
                                <p><i class="fas fa-envelope text-primary me-2"></i> info@selah.com</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Selah Kitchen</a>, All right reserved.</span>
                    </div>
                    <div class="col-md-6 my-auto text-center text-md-end text-white">
                        <!--/*** This template is free as long as you keep the below author’s credit link/attribution link/backlink. ***/-->
                        <!--/*** If you'd like to use the template without the below author’s credit link/attribution link/backlink, ***/-->
                        <!--/*** you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". ***/-->
                        Designed By <a class="border-bottom" href="https://emic.co.tz">Emic-Soft Co Ltd</a>
                    </div>
                </div>
            </div>
        </div>
